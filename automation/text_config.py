...
def fc2_text(zone,sub_num,main_num,sub_total,main_total):
    return  "本日の" + zone + "サブサイン！（" + zone + "寄付き売買、" + zone + "引けで決済）\n\n" + zone + "寄り付きで買いです。\n\n" + zone + "引けで決済します。\n\n"\
            ...
            "サブサイン   　 " + sub_num + "　　 " + str(CONFIG.result_month()) + "月収支累計  " + sub_total + "\n\n"\
            "メインサイン    " + main_num + "　  　" + str(CONFIG.result_month()) + "月収支累計　" + main_total + "\n\nポチっとよろしくお願いします！\n\n"\
