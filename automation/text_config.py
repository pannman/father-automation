def fc2_text(time,sub_num,main_num,sub_total,main_total):
    return  "本日の" + time + "サブサイン！（" + time + "寄付き売買、" + time + "引けで決済）\n\n" + time + "寄り付きで買いです。\n\n" + time + "引けで決済します。\n\n"\
            "メインのサインは、当会員様へメールで配信させて頂きました！\nよろしくお願いします！\n\n"\
            "4/14の" + time + "結果！\n\n"\
            "サブサイン   　 " + str(sub_num) + "　　 4月収支累計  " + sub_total + "\n\n"\
            "メインサイン    " + str(main_num) + "　  　4月収支累計　" + main_total + "\n\nポチっとよろしくお願いします！\n\n"\
            ...
            "この度、会員様、読者様のご要望に答えまして、2011/9/22より、" + time + "の取引に加えて、前場と後場の取引も追加させて頂きます。\n\n"\
