...
class FxtecunikaruponndoText():
    def __init__(self, zone, buy, main_sign, main_total, zone_lb, zone_settlement, buy_time, settlement_time):
        self.zone = zone
        self.buy = buy
        ...
        print(self.buy + "   "+str(self.zone_lb) +
    ...
    def blog_text(self):
        return "前営業日の結果！！\n\n"\
            ...
            ""+self.buy_time+"　成行で"+self.buy+"でした。"+str(self.zone_lb)+"pips by ポンド\n\n"\
            "↓　↓　↓\n\n"\
