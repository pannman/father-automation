...
def sakimononikkei_title(zone):
    return "本日の" + zone + "サブナイン!"
def sakimononikkei_text(zone,buy,sub_sign,main_sign,sub_total,main_total):
    return  "本日の" + zone + "サブサイン！（" + zone + "寄付き売買、" + zone + "引けで決済）\n\n" + zone + "寄り付きで" + buy + "です。\n\n" + zone + "引けで決済します。\n\n"\
            "メインのサインは、当会員様へメールで配信させて頂きました！\nよろしくお願いします！\n\n"\
            "" + str(CONFIG.result_month()) + "/" + str(CONFIG.result_day()) + "の" + zone + "結果！\n\n"\
            "サブサイン   　 " + sub_sign + "　　 " + str(CONFIG.result_month()) + "月収支累計  " + sub_total + "\n\n"\
            "メインサイン    " + main_sign + "　  　" + str(CONFIG.result_month()) + "月収支累計　" + main_total + "\n\nポチっとよろしくお願いします！\n\n"\
            ...
            "この度、会員様、読者様のご要望に答えまして、2011/9/22より、" + zone + "の取引に加えて、前場と後場の取引も追加させて頂きます。\n\n"\
